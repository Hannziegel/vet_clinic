...
/*Queries of the first part of the project*/
SELECT * from animals;
...
/* Queries for the second part of the Project - Query and Update animals table*/
...
/* Queries for the third part of the Project - Query multiple tables */
...
/* Queries for the forth part of the Project - Add "join table" for visits */
...
/* Analyze queries for the fifth part of the Project - Database perform audit */
